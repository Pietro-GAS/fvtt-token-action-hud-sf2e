            ...
            case 'strike':
                {
                    ...
                    if (strikeId === 'xxSF2ExUNARMEDxx') {
                        item = this.actor.system.actions.find(action => action.item?.id === 'xxSF2ExUNARMEDxx').item
                    } else {
        ...
        */
        ...
        async #performHeroAction (actor, actionId) {
            ...
            case actionId === 'drawHeroActions':
                await game.modules.get('sf2e-hero-actions')?.api?.drawHeroActions(actor)
                break
            case actionId === 'useHeroAction':
                await game.modules.get('sf2e-hero-actions')?.api?.useHeroAction(actor, actionId)
                break
            }
        ...
        #rollStrike (event, actor, actionId) {
            ...
            if (this.isRenderItem() && strike.item?.id !== 'xxSF2ExUNARMEDxx') {
