...
export const STRIKE_USAGE = {
    melee: { name: 'SF2E.WeaponRangeMelee' },
    ranged: { name: 'SF2E.NPCAttackRanged' },
    thrown: { name: 'SF2E.TraitThrown' }
}
 ...
 */
export const GROUP = {
    attack: { id: 'attack', name: 'SF2E.AttackLabel', type: 'system' },
    toggles: { id: 'toggles', name: 'SF2E.TogglesLabel', type: 'system' },
    strikes: { id: 'strikes', name: 'SF2E.StrikesLabel', type: 'system' },
    actions: { id: 'actions', name: 'SF2E.ActionsActionsHeader', type: 'system' },
    reactions: { id: 'reactions', name: 'SF2E.ActionsReactionsHeader', type: 'system' },
    freeActions: { id: 'free-actions', name: 'SF2E.ActionsFreeActionsHeader', type: 'system' },
    passives: { id: 'passives', name: 'SF2E.NPC.PassivesLabel', type: 'system' },
    ...
    ancestryFeatures: { id: 'ancestry-features', name: 'SF2E.Actor.Character.FeatSlot.AncestryFeaturesHeader', type: 'system' },
    classFeatures: { id: 'class-features', name: 'SF2E.Actor.Character.FeatSlot.ClassFeaturesHeader', type: 'system' },
    ancestryFeats: { id: 'ancestry-feats', name: 'SF2E.Actor.Character.FeatSlot.AncestryHeader', type: 'system' },
    classFeats: { id: 'class-feats', name: 'SF2E.Actor.Character.FeatSlot.ClassHeader', type: 'system' },
    skillFeats: { id: 'skill-feats', name: 'SF2E.Actor.Character.FeatSlot.SkillHeader', type: 'system' },
    generalFeats: { id: 'general-feats', name: 'SF2E.Actor.Character.FeatSlot.GeneralHeader', type: 'system' },
    bonusFeats: { id: 'bonus-feats', name: 'SF2E.Actor.Character.FeatSlot.BonusHeader', type: 'system' },
    spells: { id: 'spells', name: 'SF2E.Item.Spell.Plural', type: 'system' },
    heroPoints: { id: 'hero-points', name: 'SF2E.Actor.Resource.HeroPoints', type: 'system' },
    mythicPoints: { id: 'mythic-points', name: 'SF2E.Actor.Resource.MythicPoints', type: 'system' },
    initiative: { id: 'initiative', name: 'SF2E.InitiativeLabel', type: 'system' },
    perceptionCheck: { id: 'perception-check', name: 'SF2E.PerceptionLabel', type: 'system' },
    coreSkills: { id: 'core-skills', name: 'SF2E.CoreSkillsHeader', type: 'system' },
    loreSkills: { id: 'lore-skills', name: 'SF2E.LoreSkillsHeader', type: 'system' },
    conditions: { id: 'conditions', name: 'SF2E.ConditionsLabel', type: 'system' },
    ...
    effects: { id: 'effects', name: 'SF2E.EffectsLabel', type: 'system' },
    combat: { id: 'combat', name: 'tokenActionHud.combat', type: 'system' },
    token: { id: 'token', name: 'tokenActionHud.token', type: 'system' },
    recoveryCheck: { id: 'recovery-check', name: 'SF2E.Check.Specific.Recovery', type: 'system' },
    rests: { id: 'rests', name: 'tokenActionHud.sf2e.rests', type: 'system' },
    saves: { id: 'saves', name: 'SF2E.SavesHeader', type: 'system' },
 ...
 */
export const SKILL = {
    acrobatics: { name: 'SF2E.SkillAcrobatics' },
    arcana: { name: 'SF2E.SkillArcana' },
    athletics: { name: 'SF2E.SkillAthletics' },
    computers: { name: 'SF2E.SkillComputers' },
    crafting: { name: 'SF2E.SkillCrafting' },
    deception: { name: 'SF2E.SkillDeception' },
    diplomacy: { name: 'SF2E.SkillDiplomacy' },
    intimidation: { name: 'SF2E.SkillIntimidation' },
    lore: { name: 'SF2E.SkillLore' },
    medicine: { name: 'SF2E.SkillMedicine' },
    nature: { name: 'SF2E.SkillNature' },
    occultism: { name: 'SF2E.SkillOccultism' },
    perception: { name: 'SF2E.PerceptionLabel' },
    performance: { name: 'SF2E.SkillPerformance' },
    piloting: { name: 'SF2E.SkillPiloting' },
    religion: { name: 'SF2E.SkillReligion' },
    society: { name: 'SF2E.SkillSociety' },
    stealth: { name: 'SF2E.SkillStealth' },
    survival: { name: 'SF2E.SkillSurvival' },
    thievery: { name: 'SF2E.SkillThievery' }
}