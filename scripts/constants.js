...
export const GROUP = {
    ...
    weapons: { id: 'weapons', name: 'tokenActionHud.sf2e.weapons', type: 'module' },
    shields: { id: 'shields', name: 'tokenActionHud.sf2e.shields', type: 'module' },
    ...
    socialConditions: { id: 'social-conditions', name: 'tokenActionHud.sf2e.socialConditions', type: 'module' },
    otherConditions: { id: 'other-conditions', name: 'tokenActionHud.sf2e.otherConditions', type: 'module' },
    ...
    rests: { id: 'rests', name: 'tokenActionHud.sf2e.rests', type: 'module' },
...
export const SKILL = {
    ...
    computers: { name: 'PF2E.SkillComputers' },
    ...
    piloting: { name: 'PF2E.SkillPiloting' },
